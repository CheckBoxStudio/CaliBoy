...
QImgZoomViewer::QImgZoomViewer(QWidget *parent)
    : QWidget(parent)
    , m_sourceView(0)
    , m_scale(I_SCALE)
{
...
QImgZoomViewer::~QImgZoomViewer()
{
    cleanDrawed();
}
void QImgZoomViewer::setupme()
{
...
void QImgZoomViewer::setZoomSourceView(QImgViewer *view)
{
    cleanDrawed();
    if (0 != m_sourceView) {
...
void QImgZoomViewer::copyGridCorners()
{
...
void QImgZoomViewer::cleanDrawed()
{
...
void QImgZoomViewer::slotViewChanged()
{
    cleanDrawed();
...
void QImgZoomViewer::slotFocusChanged(int x, int y)
{
    mx = x;
    my = y;
    updatePos();
}
void QImgZoomViewer::slotCornerPicked(QPointF &corner)
{
...
void QImgZoomViewer::slotCornerRemoved()
{
    const int n = m_sourceView->getPickedNum();
...
void QImgZoomViewer::slotDrawGridCorners()
{
