...
DlgPickView::DlgPickView(cameraScene *scene,QWidget *parent)
    : QDialog(parent)
{
    setWindowTitle(QString::fromLocal8Bit("Pick Views"));
    setFont(QFont(QString::fromLocal8Bit("Microsoft Yahei")));
    QLabel* _label = new QLabel(QString::fromLocal8Bit("Grid Size [X-Y] (mm):"),this);
    ...
    m_sizey->setText("30");
    m_butok = new QPushButton(QString::fromLocal8Bit("Confirm"),this);
    m_butclose = new QPushButton(QString::fromLocal8Bit("Cancel"),this);
...
DlgPickView::~DlgPickView(void)
{
    m_tw->clear();
    m_PickList.clear();
}

void DlgPickView::checkAll(bool bOn)
{
...
void DlgPickView::checkAllChanged()
{
