...
/* Reset font size */
$('#medA').click(function() {
		$('.mainContent .heading').css('font','600 16px/1 Microsoft YaHei UI');
		$('.mainContent h1').css('font','600 18px/1.2 Microsoft YaHei UI');
		$('.mainContent h2').css('font','600 16px/1.2 Microsoft YaHei UI');
		$('.mainContent h3').css('font','600 14px/1.2 Microsoft YaHei UI');
		$('.mainContent p').css('font','13px/20px YaHei Consolas Hybrid');
		$('.mainContent li').css('font','400 13px/1 YaHei Consolas Hybrid');
		$('.mainContent li').css('line-height','14px');
		$('.mainContent .toc li').css('font', 'normal 10px/1.2 YaHei Consolas Hybrid');
		$('.mainContent table').css('font','13px/1.2 YaHei Consolas Hybrid');
		$('.mainContent .heading p').css('font','600 16px/1 Microsoft YaHei UI');
		$('.mainContent .indexboxcont li').css('font','600 13px/1 YaHei Consolas Hybrid');
		$('.t_button').removeClass('active')
		$(this).addClass('active')
});
